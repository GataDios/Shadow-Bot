...
let handler = async (m, { conn, text, isMods, isOwner }) => {
    ...
    if (isMods || isOwner || m.fromMe) {
        ...
        m.reply('En proceso.. le llego notificacion a todos mis moderadores, tan pronto puedan me agregaran al grupo /// NO HACER SPAM DEL COMANDO CON EL LINK O SERAN BLOQUEADOS')
    }
}
