    ...
    if ((isMedia && !m.message.videoMessage || isQuotedImage) && args.length == 0) {
      ...
      await ffmpeg(`./${media}`)
        ...
        .on('error', function (e) {
          ...
          m.reply(`Falló, en el momento de la conversión ${tipe} a la pegatina, asegúrese de que sea inferior a 10 segundos`)
        })
        .on('end', function () {
          console.log('Finish')
          buff = fs.readFileSync(ran)
      ...
      m.reply(`Enviar imagen / video de leyenda de dengan *${usedPrefix + command}* o responder a los medios ya enviados en el chat!`)
    }
  } catch (e) {
    console.log(e)
  }
