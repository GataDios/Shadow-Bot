...
let handler  = async (m, { conn, usedPrefix }) => { 
  ...
  await m.reply('*GRACIAS POR SOLICITAR EL MENU DE EXPLICACIONES/nLEA DETALLADAMENTE CADA COMANDO Y SU EXPLICACION!! /// ALGUNOS COMANDOS NO APARECEN AQUI, SE ESTA TRABAJANDO EN AGREGARLOS*')
