...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} Ganar!` : isTie ? 'Juego terminado' : `Esperando @${room.game.currentTurn.split('@')[0]}`}
Escriba *nyerah* para rendirse
`.trim()
