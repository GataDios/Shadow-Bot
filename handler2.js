...
let simple = require('./lib/simple4')
...
let wel = `https://hardianto-chan.herokuapp.com/api/tools/welcomer?nama=${encodeURIComponent(this.getName(user))}&namaGb=${encodeURIComponent(this.getName(jid))}&pepeGb=${ppgc}&totalMem=${encodeURIComponent(groupMetadata.participants.length)}&pepeUser=${pp}&bege=https://img.kirameki.one/LTqHsfYS.jpg&apikey=hardianto`
 this.sendFile(jid, wel, 'welcome.png', text, { 
key : {
...
let image = `https://hardianto-chan.herokuapp.com/api/tools/leave?nama=${encodeURIComponent(this.getName(user))}&namaGb=${encodeURIComponent(this.getName(jid))}&pepeGb=${ppgc}&totalMem=${encodeURIComponent(groupMetadata.participants.length)}&pepeUser=${pp}&bege=https://img.kirameki.one/LTqHsfYS.jpg&apikey=hardianto`
